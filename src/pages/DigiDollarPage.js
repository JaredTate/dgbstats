      ...
      <CardContent sx={{ py: 4, textAlign: 'center' }}>
        ...
        >
          <Typography variant="body2">
            ...
            Oracle system is in <strong>Phase Two</strong> with 6-of-11 MuSig2 consensus active on testnet21 (port 12035).
          </Typography>
        </Alert>
      </CardContent>
    </Card>
          ...
          <List>
            ...
            <ListItem>
              ...
              <ListItemText
                ...
                secondary="Phase Two active: 6-of-11 MuSig2 consensus on testnet21 (port 12035). Oracle bundle format: v0x03."
              />
            </ListItem>
            <ListItem>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={4}>
            <Box sx={{ textAlign: 'center', p: 2 }}>
              ...
              <Typography variant="body2">
                11 oracles with 6-of-11 consensus active on testnet21.
    ...
    <Card elevation={3} sx={{ p: 3, mb: 4, borderRadius: '12px' }}>
      ...
      <Grid container spacing={3}>
          ...
          >
            ...
            <Box sx={{ mb: 3, maxHeight: '400px', overflowY: 'auto' }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                <CheckCircleIcon sx={{ color: '#4caf50', mr: 1, fontSize: '1.2rem' }} />
                <Typography variant="body2">
                  <strong>Oracle System (Phase Two)</strong> - 6-of-11 MuSig2 Consensus Active on testnet21
                </Typography>
              </Box>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                <ConstructionIcon sx={{ color: '#ff9800', mr: 1, fontSize: '1.2rem' }} />
                <Typography variant="body2" color="text.secondary">
                  <strong>MuSig2 Oracle Validation (6-of-11)</strong> - In Progress
                </Typography>
              </Box>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                <ConstructionIcon sx={{ color: '#ff9800', mr: 1, fontSize: '1.2rem' }} />
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Oracle System - Phase Two Active (6-of-11 MuSig2 Consensus on testnet21)
            </Typography>
            ...
            <List dense sx={{ pl: 0, maxHeight: '400px', overflowY: 'auto' }}>
              ...
              <ListItem sx={{ pl: 0 }}>
                <ListItemIcon><CheckCircleIcon sx={{ color: '#4caf50', fontSize: '1.2rem' }} /></ListItemIcon>
                <ListItemText
                  primary="Phase Two Oracle Consensus (6-of-11 MuSig2)"
                  secondary="Active on testnet21 - 11 oracles, 6-of-11 consensus required"
                />
              </ListItem>
              <ListItem sx={{ pl: 0 }}>
                <ListItemIcon><CheckCircleIcon sx={{ color: '#4caf50', fontSize: '1.2rem' }} /></ListItemIcon>
      ...
      <Alert severity="success" sx={{ mt: 3 }}>
        <Typography variant="body2">
          ...
          in Phase Two with 6-of-11 MuSig2 consensus active on testnet21. DigiDollar activated on testnet (v9.26.0-RC18).
