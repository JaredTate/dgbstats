      ...
      <CardContent sx={{ py: 4, textAlign: 'center' }}>
        ...
        >
          <Typography variant="body2">
            ...
            Oracle system is in <strong>Phase Two</strong> with 9-of-17 MuSig2 consensus active on testnet23 (port 12030).
          </Typography>
        </Alert>
      </CardContent>
    </Card>
          ...
          <List>
            ...
            <ListItem>
              ...
              <ListItemText
                ...
                secondary="Phase Two active: 9-of-17 MuSig2 consensus on testnet23 (port 12030). Oracle bundle format: v0x03."
              />
            </ListItem>
            <ListItem>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={4}>
            <Box sx={{ textAlign: 'center', p: 2 }}>
              ...
              <Typography variant="body2">
                17 oracles with 9-of-17 consensus active on testnet23.
    ...
    <Card elevation={3} sx={{ p: 3, mb: 4, borderRadius: '12px' }}>
      ...
      <Grid container spacing={3}>
          ...
          >
            ...
            <Box sx={{ mb: 3, maxHeight: '400px', overflowY: 'auto' }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                <CheckCircleIcon sx={{ color: '#4caf50', mr: 1, fontSize: '1.2rem' }} />
                <Typography variant="body2">
                  <strong>Oracle System (Phase Two)</strong> - 9-of-17 MuSig2 Consensus Active on testnet23
                </Typography>
              </Box>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
              Oracle System - Phase Two Active (9-of-17 MuSig2 Consensus on testnet23)
            </Typography>
            ...
            <List dense sx={{ pl: 0, maxHeight: '400px', overflowY: 'auto' }}>
              ...
              <ListItem sx={{ pl: 0 }}>
                ...
                <ListItemText
                  ...
                  secondary="Active on testnet23 - 17 oracles, 9-of-17 consensus required"
                />
              </ListItem>
              <ListItem sx={{ pl: 0 }}>
                <ListItemIcon><CheckCircleIcon sx={{ color: '#4caf50', fontSize: '1.2rem' }} /></ListItemIcon>
      ...
      <Alert severity="success" sx={{ mt: 3 }}>
        <Typography variant="body2">
          ...
          in Phase Two with 9-of-17 MuSig2 consensus active on testnet23. DigiDollar activated on testnet (v9.26.0-RC18).
